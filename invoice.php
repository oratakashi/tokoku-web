...
<tr>
	...
	<img src="<?php echo $dta['logo']; ?>" height="100px" alt="LOGO" /><br>
...
?>
			<tr>
				<td><?php echo strtoupper($sql['nama_barang']); ?></td>
...
?>
			<tr>
				<td style="border-top:1px solid #000000;" colspan=4 align="center"><?php echo $pesan?><br><br><br></td>
			</tr>
			<tr>
				<td colspan="4"></td>
			</tr>
