...
$pdf->ln();
    ...
    $pdf->Cell(6,1,'Deskripsi','LRTB',0,'C');
    $pdf->Cell(3,1,'Qty','LRTB',0,'C');
    $pdf->Cell(3,1,'Harga Eceran','LRTB',0,'C');
	//$pdf->Cell(3,1,'Harga Grosir 1','LRTB',0,'C');
	//$pdf->Cell(3,1,'Harga Grosir 2','LRTB',0,'C');
...
while ($data = mysql_fetch_array($query)) {
    $pdf->Cell(1,1,$no,'LRTB',0,'C');
    $pdf->Cell(6,1,ucwords($data['nama_bahan']),'LRTB',0,'L');
