...
<tr>
	<td style="border:0px solid #000000;" colspan="2" align="center"><font size="6"><strong><?php echo $dta['perusahaan']?></strong></font><br><?php echo $dta['alamat']?> <br>Telp: <?php echo $dta['tlp']?></td>
</tr>
	<tr>
	...
	<td style="border-top:2px solid #000000;" colspan="2">
		<table width="350px" align="center" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="border-top:1px solid #000000;">JUMLAH</td>
			</tr>
<?php
...
?>
			<tr>
				...
				<td align="left"><?php echo number_format($sql['harga']);?></td><td align="center"><?php echo $sql['jumlah']." ".$satuan; ?></td>
...
$no++;
			...
			<tr>
				<td colspan=2></td>
				<td>BAYAR</td>
				<td align="right"><?php echo number_format($data['bayar']+$data['kembalian']); ?></td>
			</tr>
<?php
...
?>
			<tr>
				<td style="border-top:1px solid #000000;" colspan=4 align="center"><?php echo $pesan?><br></td>
			</tr>
			<tr>
				<td colspan="4"></td>
			</tr>
