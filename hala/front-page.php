<?php
$qryk = mysql_query("SELECT * FROM setting WHERE iduser='{$_SESSION['id']}'");
$dta  = mysql_fetch_array($qryk);

$tanggal = date("Y-m-d");
$kd = @$_SESSION['kode'];
$kts = substr($kd,0,3);
 if ($kts == 'TRJ'){ 
 echo("<META HTTP-EQUIV=Refresh CONTENT=\"1;URL=index.php?page=front-page\">");
 ?>
 <section>
        <div class="container">
            <div class="row">
