<?php 
$kode=$_GET['kode'];
$query = mysql_query("select * from tblpaket_produk where paket_produk='$kode'") or die(mysql_error());
                ...
                <div class="blog">
                    <div class="blog-item">
					  ...
					  <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>				  
							  <tr>
								  <td colspan="4"><?php echo $data['paket_produk'] ; ?></td>
							  </tr>
							  </tbody>
							  <thead>
							  <tr>
							  ...
							  <tbody>
							  <form action="?page=editing-paket-produk" method="POST">
							  			<?php $kd=$data['paket_produk'];
			$s=mysql_query("select * from dtlpaket_produk where paket_produk='$kd'");
			while($sql=mysql_fetch_array($s)){?>
							  <tr>
							  <td><?php echo $sql['nama_produk']; ?></td><td><?php echo $sql['jumlah']; ?></td><td>Rp. <?php echo number_format($sql['harga']); ?></td><td><a class="btn btn-danger btn-xs" href="?page=del-edit-paket-produk&kode=<?php echo $sql['paket_produk']; ?>&nama=<?php echo $sql['nama_produk']; ?>">Hapus <i class="fa fa-trash-o "></i></a></td>
							  </tr>
							  <?php } ?>
							  <tr>
							  <td>
...
<tr><td colspan="2"><h5><b>Harga Jual :</b></h5></td><td colspan="2"><input type="text" class="form-control" name="hargaj" value="<?php echo $data['hargaj']; ?>"></td></tr>
							  </tbody>
				</table>
